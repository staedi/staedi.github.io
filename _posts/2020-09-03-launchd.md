---
layout: post
title:  "Using Launchd for scheduling on Mac!"
categories: [dev]
tags: [mac, git]
nav_order: 6
parent: Dev
...
First *dash* character means there's no currently running job, and the number 0 indicates the job ended successfully without any errors. When error occurs, positive error will show up instead of 0.
