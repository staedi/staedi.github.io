...
While it should be a straightforward step to register this on `crontab` to automate regular `git` operation, it didn't work to my favor. I resorted to `launchd` instead.
