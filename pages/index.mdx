...
Using [mlx-lm](https://github.com/ml-explore/mlx-lm), fine-tuned open-source LLMs for Corerence Resolution task (Model available at https://github.com/staedi/coref-llama-3.2)
